...
function searchTest(driver) {
  ...
  driver.findElement(By.className('toDo-title')).sendKeys('Critical Title');
  driver.findElement(By.className('toDo-body')).sendKeys('Critical Body');

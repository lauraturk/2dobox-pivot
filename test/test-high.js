...
function searchTest(driver) {
  ...
  driver.findElement(By.className('idea-title')).sendKeys('High Title');
  driver.findElement(By.className('idea-body')).sendKeys('High Body');
  ...
  driver.findElement(By.className('idea-body')).sendKeys('Testing Body');
  driver.findElement(By.className('save-button')).click();
  driver.findElement(By.className('high')).click();
